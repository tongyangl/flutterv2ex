...
class ContentTitleView extends StatefulWidget {
  FeedItemData _data;
  var context;

  ContentTitleView(this._data, this.context);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _ContentTitleView(_data, context);
  }
}

class _ContentTitleView extends State<ContentTitleView> {
  FeedItemData _data;
  var parentContext;

  _ContentTitleView(this._data, this.parentContext);
